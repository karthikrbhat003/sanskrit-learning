...
*   **[Script & Pronunciation](./Reference/Pronunciation_and_Script.md)**: Alphabets, Devanagari script, and pronunciation guide.
*   **[Noun Declensions (Vibhakti)](./Reference/Vibhakti_Table_Noun_Declensions.md)**: Tables for cases (nominative, accusative, etc.) across genders.
...
*   **[Day 004: Number Agreement & Questions](./Lessons/Day_004_Number_Agreement_and_Questions.md)** (Singular / Dual / Plural transformations and essential question words)
...
*   **[Day 019: Future Tense (Lṛṭ)](./Lessons/Day_019_Future_Tense_Lrit_Lakara.md)** (Predictions, aspirations, and 3x3 future conjugations)
*   **[Day 020: Potential Mood (Vidhiliṅ)](./Lessons/Day_020_Potential_Mood_Vidhiling_Lakara.md)** (Expressing advice, moral duty, and 'should/ought to')
*   **[Day 021: Imperative Mood (Loṭ)](./Lessons/Day_021_Imperative_Mood_Lot_Lakara.md)** (Commands, polite requests, invitations, and blessings)
*   **[Day 022: Essential Avyayas](./Lessons/Day_022_Essential_Avyayas_Indeclinables.md)** (Correlative connectors: yadā-tadā, yadi-tarhi, yathā-tathā)
*   **[Day 023: Upasargas (Prefixes)](./Lessons/Day_023_Upasargas_Verbal_Prefixes.md)** (The 22 verbal prefixes and meaning transformers)
...
*   **[Day 029: Greedy Traveler (Panchatantra)](./Lessons/Day_029_Panchatantra_Greedy_Traveler_Lyap.md)** (Prefixed Lyap gerunds: praviśya, āgatya, praṇamya, vijñāya)
*   **[Day 030: Four Scholars & Lion (Panchatantra)](./Lessons/Day_030_Panchatantra_Four_Scholars_Shatri.md)** (Present continuous Shatṛ participles: gacchan, paśyan, hasan)
*   **[Day 031: Tiger & Traveler (Hitopadesha)](./Lessons/Day_031_Hitopadesha_Tiger_and_Traveler_Samasa.md)** (Sanskrit Compound Words: Tatpuruṣa, Karmadhāraya, Dvandva, Bahuvrīhi)
*   **[Day 032: King Chitragriva (Hitopadesha)](./Lessons/Day_032_Hitopadesha_Chitragriva_Passive_Voice.md)** (Passive Voice / Karmaṇi Prayoga: kriyate, paṭhyate, dṛśyate)
*   **[Day 033: Valmiki Ramayana Entry](./Lessons/Day_033_Epic_Ramayana_Anushtubh_Meter.md)** (The First Epic Poem & 32-syllable Anuṣṭubh meter structure)
*   **[Day 034: Bhagavad Gita Syntax](./Lessons/Day_034_Philosophical_Bhagavad_Gita_Syntax.md)** (Deep linguistic breakdown of BG 2.47 and BG 4.7)
*   **[Day 035: Grand Finale & Lifelong Roadmap](./Lessons/Day_035_Grand_Finale_and_Lifelong_Sanskrit_Roadmap.md)** (4-step reading algorithm, lifelong texts, and universal shanti mantra)
...
* **Day 2**: Simple sentences & Masculine nouns ($a$-ending: *rāmaḥ, gajaḥ, bālakaḥ*)
* **Day 3**: Feminine ($ā$/$ī$-ending) and Neuter ($a$-ending) noun basics
* **Day 4**: Number agreement (Singular, Dual, Plural) & Question words (*kim, kutra, kadā, katham*)
* **Day 5**: Present tense (*laṭ lakāra*) across all three persons (3rd, 2nd, 1st)
* **Day 5B**: **Master Guide to Daily Actions** (Swimming, walking, dancing, bathing, cooking, brushing, jumping, dressing, and 50+ bodily actions)
...
* **Days 8–9**: **Cases 3 & 4** — Instrumental (*By/With*) & Dative (*For/To*)
* **Days 10–11**: **Cases 5 & 6** — Ablative (*From/Than*) & Genitive (*Of/Possession*)
* **Days 12–13**: **Cases 7 & 8** — Locative (*In/At/On*) & Vocative (*Direct Address*)
* **Days 14–15**: **Review & Synthesis** — Full case practice with short reading passages
...
* **Days 19–20**: **Future & Potential** (*lṛṭ lakāra* & *vidhi-liṅ*)
* **Days 21–22**: **Imperative Mood** (*loṭ lakāra*) — Commands, polite requests, and wishes
* **Days 23–24**: **Indeclinables & Prefixes** (*Avyayas* like *ca, api, yadi-tarhi* & *Upasargas*)
* **Day 25**: **Sandhi Essentials** — Core vowel and consonant junction rules
...
* **Days 31–32**: **Hitopadesha Tales** — Compound words (*Samāsas*) & Passive voice (*Karmaṇi Prayoga*)
* **Days 33–34**: **Epics & Gita** — Valmiki Ramayana (*Anuṣṭubh* meter) & Bhagavad Gita syntactic analysis
* **Day 35**: **Grand Finale** — The 4-step universal reading algorithm & lifelong learning roadmap
